    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-6 lg:px-8 pb-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Features */}
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="card p-6 rounded-2xl text-center hover:scale-[1.02] transition-transform">
              ...
              <p className="text-text-muted text-sm">Get a unique URL in seconds. No signup required.</p>
            </div>
            ...
            <div className="card p-6 rounded-2xl text-center hover:scale-[1.02] transition-transform">
              ...
              <p className="text-text-muted text-sm">Delete your text anytime with your secret password.</p>
            </div>
            ...
            <div className="card p-6 rounded-2xl text-center hover:scale-[1.02] transition-transform">
              ...
              <p className="text-text-muted text-sm">Your text stays online until you decide to delete it.</p>
            </div>
          </div>
        </div>
      </div>
